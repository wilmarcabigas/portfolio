...
function App() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-900 via-slate-800 to-blue-900 px-4 pt-28">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 w-full flex justify-center">
        <nav className="w-full max-w-5x2 bg-gray-900 rounded-b-xl shadow-lg flex justify-between items-center px-110 py-6 mt-0">
          <span className="text-white text-4xl font-extrabold">Portfolio</span>
          <ul className="flex space-x-10">
            <li>
              <a href="#home" className="text-slate-200 hover:text-white transition-colors text-xl">Home</a>
            </li>
            
            <li>
              <a href="#skills" className="text-slate-200 hover:text-white transition-colors text-xl">Skills</a>
            </li>
            <li>
              <a href="#contact" className="text-slate-200 hover:text-white transition-colors text-xl">Contact</a>
            </li>
          </ul>
        </nav>
      </header>
      ...
      {/* Home Section */}
      <section id="home" className="flex flex-col sm:flex-row items-center justify-center space-y-6 sm:space-y-0 sm:space-x-16 mb-6 w-full mt-16">
